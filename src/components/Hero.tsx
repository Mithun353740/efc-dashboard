...
export default function Hero({ player }: HeroProps) {
  ...
  return (
    <section className="relative h-[65svh] min-h-[450px] overflow-hidden bg-brand-dark dark:bg-black transition-colors">
      ...
      <div className="absolute right-0 bottom-0 h-full w-[80%] md:w-1/2 rtl-flip opacity-50 md:opacity-100">
        <motion.img
      ...
      <div className="relative h-full max-w-7xl mx-auto px-8 flex items-center">
        <div className="w-full md:w-[60%] z-10">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-black text-white leading-[0.8] tracking-tighter mb-2 uppercase break-words">
              {firstName}
            </h1>
            <h2 className="text-6xl md:text-8xl lg:text-9xl font-black text-outline text-white leading-[0.8] tracking-tighter mb-8 uppercase break-words">
              {lastName}
            </h2>
