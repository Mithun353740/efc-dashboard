...
interface ProductionFirebaseContextType {
...
const ProductionFirebaseContext = createContext<ProductionFirebaseContextType | undefined>(undefined);

export function ProductionFirebaseProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ProductionFirebaseContext.Provider value={value}>
      {children}
    </ProductionFirebaseContext.Provider>
  );
}

export function useProductionFirebase() {
  const context = useContext(ProductionFirebaseContext);
  if (context === undefined) {
    throw new Error('useProductionFirebase must be used within a ProductionFirebaseProvider');
  }
  return context;
}
